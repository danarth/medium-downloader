...
const injectDownloadButtons = () => {
    ...
    sidebarButton.className = 'u-textAlignCenter u-marginVertical10'
    sidebarButton.innerHTML = getDownloadButton()
    sidebar.appendChild(sidebarButton)
    
    const tempContainer = document.createElement('div')
    tempContainer.innerHTML = getDownloadButton()
    const actionsBarButton = tempContainer.firstChild
    actionsBar.appendChild(actionsBarButton)
}
